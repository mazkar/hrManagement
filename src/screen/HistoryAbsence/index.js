...
export default function HistoruAbsence({ navigation }) {
  ...
  async function getData() {
    try {
      let res = await axios({
        url: `${baseUrl.URL}api/userrole/userAbsenceGet30DaysHistory/${userData?.hrEmployeeId}`,
        method: "get",
        timeout: 8000,
        headers: {
  ...
  return (
    <ColorBgContainer>
      <RootContainer isTransparent>
        <AppBar title="History 30 Days" dataTaskPending={dataTaskPending} />
                ...
                >
                  <View style={{ flexDirection: "row", alignSelf: "center" }}>
                    ...
                    <View style={{ marginLeft: ms(6) }}>
                      ...
                      >
                        {moment(e.checkInDate).format("DD MMMM YYYY")}
                      </Text>
                    </View>
                  </View>
                  <View
                  ...
                  >
                    <View>
                      ...
                      <Text style={{ alignSelf: "center", fontSize: ms(10) }}>
                        {moment(e?.checkInDate).format("hh:mm")}
                      </Text>
                    </View>
                    <View>
                      <Text style={{ fontWeight: "600", fontSize: 12 }}>
                      ...
                      <Text style={{ alignSelf: "center", fontSize: ms(12) }}>
                        {e?.duration} Hour
                      </Text>
                    </View>
                    <View>
                      ...
                      {e?.checkOutDate == null ? (
                        ...
                        <Text style={{ alignSelf: "center", fontSize: ms(10) }}>
                          {moment(e?.checkOutDate).format("hh:mm")}
                        </Text>
                      )}
                    </View>
                  </View>
